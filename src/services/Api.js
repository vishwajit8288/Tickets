...
const getAssignedTickets = async () => {
    const result = await axios.get(ApiUrl + Constant.SHOW_ASSIGN_TICKET_BY_EMP_ID);
    return result.data
}
...
export {getLogin,getDeptList,addDepartment,updateDepartmant,onDeleteDepartment,getRoleList,addEmployee,editEmpData,deleteEmpData,updateEmployee,getEmpList,getLeaveData,addLeave,editLeaveData,addTicket,getTicket,editTicketData,deleteTicketData,getSuperAdmin,getTicketById,getNewTickets,getAssignedTickets,GetEmployeesByDeptId}
